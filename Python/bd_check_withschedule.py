...
# Schedule the task to run at 09:15 AM on Sunday through Wednesday
schedule.every().sunday.at("09:15").do(check_birthdays)
schedule.every().monday.at("09:15").do(check_birthdays)
schedule.every().tuesday.at("09:15").do(check_birthdays)
schedule.every().wednesday.at("09:15").do(check_birthdays)
